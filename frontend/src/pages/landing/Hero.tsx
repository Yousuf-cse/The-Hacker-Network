      ...
      <main className="px-6 max-w-7xl mx-auto">
        <div className="text-center mt-20 mb-8">
          ...
          <p className="font-lightItalic text-lg md:text-xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed">
            Connect with like-minded student entrepreneurs ready to share a hacker house experience. 
            Discover your crew, find your space, and build your future together
          </p>
          </Reveal>
