...
function RoomModal({
  ...
  const currentMessages =
    roomMessages[selectedRoom.id] || selectedRoom.messages;
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      ...
      >
        {/* Room Header */}
        <div
          className={`flex items-center justify-between p-6 bg-gradient-to-r ${selectedRoom.gradient} text-white`}
        >
            ...
            <div className="p-4 border-b border-gray-200">
              ...
              <div className="space-y-3">
                {selectedRoom.members.map((member) => (
                  <div
                    key={member.id}
                    className="flex items-center space-x-3 p-3 bg-white rounded-lg border border-gray-100 hover:border-primary-200 transition-colors"
                  >
...
export default function HackerNetworkPage() {
  ...
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      ...
      if (
        ...
        !roomModalRef.current.contains(event.target as Node)
      ) {
      ...
      messages: [
        {
          id: 1,
          sender: "Sarah",
          message: "Hey everyone! Ready for today's sprint?",
          time: "9:30 AM",
          isOwn: false,
        },
        {
      ...
      messages: [
        {
          id: 1,
          sender: "Emma",
          message: "Our ML model is showing great results!",
          time: "10:15 AM",
          isOwn: false,
        },
        {
          id: 2,
          sender: "David",
          message: "The accuracy improved by 15%",
          time: "10:17 AM",
          isOwn: false,
        },
      ],
      ...
      messages: [
        {
          id: 1,
          sender: "Ryan",
          message: "Pitch deck is ready for tomorrow!",
          time: "2:45 PM",
          isOwn: false,
        },
      ],
      ...
      messages: [
        {
          id: 1,
          sender: "Alex",
          message: "New smart contract deployment successful!",
          time: "11:20 AM",
          isOwn: false,
        },
        {
          id: 2,
          sender: "Maria",
          message: "Gas fees are looking good today",
          time: "11:25 AM",
          isOwn: false,
        },
      ],
      ...
      messages: [
        {
          id: 1,
          sender: "Sophie",
          message: "New design system is ready for review",
          time: "3:15 PM",
          isOwn: false,
        },
        {
          id: 2,
          sender: "Jake",
          message: "The color palette looks amazing!",
          time: "3:18 PM",
          isOwn: false,
        },
      ],
  ...
  const availableRooms = allRooms.filter(
    (room) => !joinedRooms.includes(room.id)
  );
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      id: 1,
      sender: "Sarah",
      message: "Hey! Are you interested in joining our Web3 project?",
      time: "2:30 PM",
      isOwn: false,
    },
    {
      id: 2,
      sender: "You",
      message: "Absolutely! Tell me more about it.",
      time: "2:32 PM",
      isOwn: true,
    },
    {
      ...
      sender: "Sarah",
      message:
        "We're building a DeFi platform and need a frontend developer. Perfect match!",
      time: "2:35 PM",
      isOwn: false,
    },
  ]);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="flex items-center justify-between p-6 bg-white border-b border-gray-100">
        <h1 className="font-brand text-xl md:text-2xl font-bold text-gray-800">
          The Hacker Network
        </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4 max-w-2xl">
                {rooms.map((room, index) => (
                  <div
                    ...
                    className={`${
                      index === 2
                        ? "md:col-span-2 lg:col-span-1 xl:col-span-2 flex justify-center"
                        : ""
                    }`}
                  >
                    <div
                      className={`grid grid-cols-2 gap-1 bg-gradient-to-br ${
                        room.gradient
                      } p-3 rounded-lg shadow-xl hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer ${
                        index === 2 ? "w-64" : "w-full"
                      }`}
                    ...
                    >
                      ...
                      <div className="bg-white/90 backdrop-blur-sm border border-blue-600 p-3 text-center col-span-2 rounded text-xs hover:bg-white hover:shadow-md transition-all duration-200">
                        <div className="text-blue-600 font-bold text-xs truncate">
                          {room.name}
                        </div>
                      </div>
                    </div>
            ...
            <div className="bg-gray-200 rounded-xl p-4 sm:p-6 lg:p-8 relative overflow-hidden shadow-lg">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Join a community of passionate Web3 builders, developers, and
                  innovators living and working together in our cutting-edge
                  hacker houses. Experience the perfect blend of focused
                  development time and collaborative energy.
                </p>
            ...
            <div className="bg-gradient-to-r from-primary-500 to-purple-600 rounded-xl p-6 text-white">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-center">
                  <span className="mr-2">✓</span> Curated community of verified
                  builders
                </li>
                <li className="flex items-center">
                  <span className="mr-2">✓</span> AI-powered matching for
                  perfect house fits
                </li>
                <li className="flex items-center">
                  <span className="mr-2">✓</span> Flexible stay durations from
                  weeks to years
                </li>
                <li className="flex items-center">
                  <span className="mr-2">✓</span> Access to exclusive events and
                  workshops
                </li>
              </ul>
            </div>
