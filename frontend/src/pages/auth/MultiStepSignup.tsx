...
const IMAGE_URL = "https://res.cloudinary.com/dpw89wko7/image/upload/v1755944742/get_annw1j.jpg";
...
const MultiStepSignup = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center font-inter">
      <div className="flex w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden bg-white/90 backdrop-blur-md">
        {/* Left: Image Section */}
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          <Card className="shadow-none border-0 bg-transparent rounded-none">
            <CardHeader className="space-y-3 text-center bg-gradient-to-r from-blue-600/5 to-purple-600/5 px-2 py-3">
              {renderStepIndicator()}
              <CardTitle className="text-lg font-bold text-gray-900 font-brand">
                {getStepTitle()}
              </CardTitle>
              <CardDescription className="text-gray-600 text-sm font-montserrat">
                {getStepDescription()}
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter className="flex justify-between items-center px-4 py-3 bg-gray-50/50 border-t border-gray-100">
              <Button
                variant="outline"
                onClick={handlePrevious}
                disabled={currentStep === 1 || loading}
                className="flex items-center gap-1 px-3 py-2 h-8 font-inter text-xs transition-all duration-200 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              {currentStep < 3 ? (
                <Button
                  onClick={handleNext}
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium text-xs transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-1 px-3 py-2 h-8 font-inter transform hover:scale-105"
                >
                  Continue
                ...
                <Button
                  ...
                  disabled={loading}
                  className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white font-medium text-xs transition-all duration-200 shadow-lg hover:shadow-xl px-4 py-2 h-8 font-inter transform hover:scale-105 disabled:transform-none disabled:opacity-70"
                >
                  {loading ? (
